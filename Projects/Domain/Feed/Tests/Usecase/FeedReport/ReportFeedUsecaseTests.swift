...
struct ReportSpoilerFeedUsecaseTests {
    ...
    @Test("스포일러 신고를 성공적으로 요청한다.")
    func reportSpoilerSuccess() async throws {
    ...
    @Test("스포일러 신고를 실패하면 에러를 던진다.")
    func reportSpoilerFailureThrows() async {
        let mock = MockFeedRepository()
    ...
    @Test("부적절한 피드 신고를 성공적으로 요청한다.")
    func reportImproperSuccess() async throws {
        let mock = MockFeedRepository()
    ...
    @Test("부적절한 피드 신고를 실패하면 에러를 던진다.")
    func reportImproperFailureThrows() async {
        let mock = MockFeedRepository()
