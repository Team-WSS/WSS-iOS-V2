...
///     하단 "작품 찾기" CTA는 이 화면(`DetailSearchFilterView`) 자신이 공용으로 소유하므로, 주입되는
///     콘텐츠는 **자신의 확정/하단 액션바를 갖지 않아야 한다**(`KeywordFeatureFactory.makeSearchKeywordView`의
///     `showsBottomActionBar: false` 참고).
